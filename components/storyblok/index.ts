import { hydrateInPreviewOnly } from 'src/modules/vsf-storyblok-module'
import { add } from 'src/modules/vsf-storyblok-module/components'

export default function registerComponents () {
  add('heading', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */'./Heading.vue')))
  add('button_item', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './Button.vue')))
  add('buttons', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './Buttons.vue')))
  add('html', () => import(/* webpackChunkName: "vsf-storyblok" */ './Html.vue'))
  add('image', () => import(/* webpackChunkName: "vsf-storyblok" */ './Image.vue'))
  add('driver', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './Driver.vue')))
  add('homepage_intro_section', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './HomepageIntroSection.vue')))
  ...
  add('dongler_book', () => import(/* webpackChunkName: "vsf-storyblok" */ './DonglerBook.vue'))
  add('website_rating', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './WebsiteRating.vue')))
  add('sharing', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './Sharing.vue')))
  ...
  add('hr', hydrateInPreviewOnly(() => import(/* webpackChunkName: "vsf-storyblok" */ './HorizontalRule.vue')))
