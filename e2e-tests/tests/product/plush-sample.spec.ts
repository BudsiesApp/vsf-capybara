...
const COLOR_PALETTE_CUSTOMIZATION_OPTION_LABEL = 'Color Palette';
...
test('form layout is correct', async ({ customizableProductPage, page, verticalStepsProductPage }) => {
  ...
  const colorPaletteWidget = customizableProductPage.getCustomizationWidgetByLabel(COLOR_PALETTE_CUSTOMIZATION_OPTION_LABEL);
