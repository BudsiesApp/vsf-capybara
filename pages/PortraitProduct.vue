...
export default Vue.extend({
  ...
  computed: {
    ...
    nameStepHint (): string {
      return this.$t('<strong>Please note:</strong> Write exactly what you\'d like printed above the photo here. It\'s printed as written. If you have multiple faces, you can separate each name with a comma or "&". Next, select "Add more faces" below and upload each photo separately in the order you wrote their names. Faces will be positioned from left to right in the order below, 1, 2, 3, etc.')
        .toString()
    },
